...
public class HttpRequestUtils {
    ...
    public static String sendPost(Object data, String postUrl, int timeout) throws IOException {
        String result;
        ...
        try (CloseableHttpClient httpclient =
            ...
            StringEntity input = new StringEntity(GsonUtils.toJsonString(data));
    ...
    public static String sendGet(List<NameValuePair> nvps, String getUrl, int timeout) throws Exception {
        String result;
        RequestConfig defaultRequestConfig = RequestConfig.custom()
                .setSocketTimeout(timeout)
                .setConnectTimeout(timeout)
    ...
    public static String sendGetViaProxy(List<NameValuePair> nvps, String getUrl, String proxyHost, int proxyPort, int timeout) throws Exception {
        String result;
        HttpHost proxy = new HttpHost(proxyHost, proxyPort);
        RequestConfig defaultRequestConfig = RequestConfig.custom()
                .setSocketTimeout(timeout)
